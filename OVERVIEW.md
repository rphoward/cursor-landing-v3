...
**This bundle (v3):** pseudo-Lisp scan report · **`/cursor-landing`** · install [`references/install.md`](references/install.md) · GitHub [cursor-landing-v3](https://github.com/rphoward/cursor-landing-v3)

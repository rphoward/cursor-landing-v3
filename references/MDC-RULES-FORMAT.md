...
2. **Dual-host only:** `.cursorignore` per [SKILL.md](../SKILL.md) `(phase_2_route … dual_host_when … cursorignore)` + `(managed_block_write_policy …)` — then skip step 3 below for AGENTS/GEMINI when Q6 = leave

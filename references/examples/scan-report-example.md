...
(scan_report
  ...
  (agent_surfaces_by_host
    (host claude (surfaces CLAUDE.md .mcp.json) (skills_folders) (legacy_paths) (conf high))
    (host cursor (surfaces .cursorrules) (legacy_paths .cursorrules) (conf medium))
    (host gemini (surfaces GEMINI.md .agent/) (conf high)))
  (legacy_host_signals

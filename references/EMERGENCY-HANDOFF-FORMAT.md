...
Transient session state — **not** AGENTS or `.mdc`. Written into **target repos** at `docs/EMERGENCY-HANDOFF.md` by `/cursor-landing emergency`. Overwrite each run. Factory maintainers use `docs/SESSION-HANDOFF.md` separately (not install bundle).

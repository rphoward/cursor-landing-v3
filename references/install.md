...
**Windows** (run from the cloned [cursor-landing-v3](https://github.com/rphoward/cursor-landing-v3) repo root):

```powershell
Copy-Item -Recurse -Force * "$env:USERPROFILE\.cursor\skills\cursor-landing\"
```
